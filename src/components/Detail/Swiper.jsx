...
const Swiper = () => {
  ...
  <div className="container mx-auto flex flex-col lg:flex-row justify-center lg:items-start items-start gap-10 px-6 mt-[150px]">

    {/* ---------- Left: Image Gallery Section ---------- */}
    <div className="w-full lg:w-[50%] flex flex-col items-center self-start">
      {/* ---------- Main Image ---------- */}
    ...
    <div className="bg-white px-6 py-6 rounded-2xl shadow-xl w-full lg:w-[20%] md:w-[40%] xl:w-[25%] md:ml-[60px] self-start">
