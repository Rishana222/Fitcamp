   ...
   <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-xl mt-24 lg:mt-0 h-[250px]">
      ...
      <div className="space-y-4 text-sm">
        <div className="flex justify-between">
          ...
          <span className="font-medium text-gray-800">Feri Arianto</span>
        </div>
        <div className="flex justify-between">
          <span className="font-semibold text-black">Phone Number</span>
          <span className="font-medium text-gray-800">085258974410</span>
        </div>
        <div className="flex justify-between">
          <span className="font-semibold text-black">Email</span>
          <span className="font-medium text-gray-800">Ferikiller238@gmail.com</span>
        </div>
      </div>
    </div>
    <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow-xl h-fit">
      ...
      <div className="mb-4">
        ...
        <input
          type="" placeholder='Upload transfer proof'
          className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2 "
        />
      </div>

      <button onClick={handlePaymentClick} className="text-white bg-indigo-500 w-full px-4 py-2 mt-3 rounded-full hover:bg-indigo-600 transition duration-300">
        Checkout
      </button>
    </div>
